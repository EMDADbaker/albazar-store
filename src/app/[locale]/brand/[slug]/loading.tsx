// Instant skeleton for brand browse pages.
export default function BrandLoading() {
  return (
    <div className="min-h-screen bg-paper text-coal animate-pulse">
      <div className="h-14 border-b border-coal/10" />
      <section className="px-5 sm:px-8 pt-10 pb-6 max-w-6xl mx-auto w-full space-y-3">
        <div className="h-3 w-24 bg-coal/10" />
        <div className="h-10 w-1/2 bg-coal/10 mt-4" />
      </section>
