...
export default async function ProductsAdmin({
  ...
  const sel = 'bg-ink/[0.04] border border-ink/[0.12] text-ink text-[11px] p-2 outline-none focus:border-accent/50';
  ...
  return (
    <div>
      ...
      <form className="flex flex-wrap gap-2 mb-8" action="/admin/products">
        ...
        <button className="font-mono text-[10px] uppercase tracking-wide bg-accent text-bg px-4 hover:bg-accent-bright">Filter</button>
      </form>
